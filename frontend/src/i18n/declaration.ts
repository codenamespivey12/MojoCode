...
export enum I18nKey {
  ...
  SETTINGS$IMPORT_REPO_INVALID_URL_ERROR = "SETTINGS$IMPORT_REPO_INVALID_URL_ERROR",
  SETTINGS$IMPORT_REPO_DESCRIPTION = "SETTINGS$IMPORT_REPO_DESCRIPTION",
  SETTINGS$IMPORT_REPO_PLACEHOLDER = "SETTINGS$IMPORT_REPO_PLACEHOLDER",
  ...
  AGENT$RESUME_TASK_ACTION = "AGENT$RESUME_TASK_ACTION",
  ...
  STATUS$CONFIGURED_VIA_ENVIRONMENT = "STATUS$CONFIGURED_VIA_ENVIRONMENT",
  STATUS$ENVIRONMENT_VARIABLE = "STATUS$ENVIRONMENT_VARIABLE",
